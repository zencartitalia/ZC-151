 ...
 * @version $Id: paypal.php 28-09-2012 Spike00 Modified in v1.5.1 $
 */

  define('MODULE_PAYMENT_PAYPAL_TEXT_ADMIN_TITLE', 'Pagamento PayPal Standard');
  ...
  if (IS_ADMIN_FLAG === true) {
    define('MODULE_PAYMENT_PAYPAL_TEXT_DESCRIPTION', '<strong>Pagamento PayPal Standard per sito web</strong> (Sistema vecchio, meno affidabile del pi&ugrave; recente Express Checkout)<br /><a href="http://www.zen-cart.it/partners/paypal" target="_blank">Gestisci il tuo conto PayPal.</a><br /><br /><font color="green">Istruzioni Configurazione:</font><br />1. <a href="http://www.zen-cart.it/partners/paypal" target="_blank">Registra un account PayPal - click qui.</a>
