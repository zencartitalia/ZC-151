...
define('FOOTER_TEXT_BODY', 'Copyright &copy; ' . date('Y') . ' <a href="' . zen_href_link(FILENAME_DEFAULT) . '" target="_blank">' . STORE_NAME . '</a> - '.STORE_DATIFISCALI . ' Powered by <a href="http://www.zen-cart.com" target="_blank">Zen Cart</a>');
