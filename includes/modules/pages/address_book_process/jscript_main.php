 ...
 * @version $Id: jscript_main.php 17018 2012-01-21 11:36:51 Spike00 aka Paolo De Dionigi $
 */
?>
...
<?php if (ACCOUNT_CF == 'true' && (int)ENTRY_CF_MIN_LENGTH != 0) echo '  check_input("fiscal_code", ' . ENTRY_CF_MIN_LENGTH . ', "' . ENTRY_CF_ERROR . '");' . "\n"; ?>
  // P.IVA + CF - start
