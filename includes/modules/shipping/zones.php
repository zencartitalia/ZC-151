...
// class constructor
    function zones() {
      ...
      if (IS_ADMIN_FLAG === true) {
          ...
          $default_countries = '';
 		$db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Zona " . $i ." Paesi', 'MODULE_SHIPPING_ZONES_COUNTRIES_" . $i ."', '" . $default_countries . "', 'La virgola separa la lista dei due caratteri dei codici ISO dei Paesi che fanno parte di una Zona " . $i . ".<br />Impostate 00 per indicare tutti i due caratteri dei codici ISO dei Paesi che non sono definiti in modo specifico.', '6', '0', 'zen_cfg_textarea(', now())");
        $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Zona " . $i ." Tabella di Spedizione', 'MODULE_SHIPPING_ZONES_COST_" . $i ."', '3:8.50,7:10.50,99:20.00', 'Le Aliquote di Spedizione per le destinazioni della Zona " . $i . " in base ad un gruppo di pesi/prezzi massimi di un ordine. Esempio: 3:8.50,7:10.50,...Peso/Prezzo minore o uquale a 3 costerebbe 8.50 per le destinazioni della Zona " . $i . ".<br />Inserendo come ultimo valore una percentuale, ad esempio 10000:7%, si addebita come costo il 7% del Totale Ordine', '6', '0', 'zen_cfg_textarea(', now())");
    		$db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Zona " . $i ." Costo di Packaging', 'MODULE_SHIPPING_ZONES_HANDLING_" . $i."', '0', 'Costo di Packaging per questa zona di spedizione.', '6', '0', now())");
         $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Costo di Packaging Per Ordine o Per Pacco Zona " . $i . "  (se in base al peso)' , 'MODULE_SHIPPING_ZONES_HANDLING_METHOD_" . $i."', 'Order', 'Il costo di packaging deve essere calcolato sull\'ordine o sui pacchi?', '6', '0', 'zen_cfg_select_option(array(\'Order\', \'Box\'), ', now())");
...
// shipping adjustment
    ...
    function install() {
      global $db;
      $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Abilita il Metodo delle Zone', 'MODULE_SHIPPING_ZONES_STATUS', 'True', 'Abilitare la modalit&agrave; di spedizione Tariffa per Zona?', '6', '0', 'zen_cfg_select_option(array(\'True\', \'False\'), ', now())");
      $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Metodo di Calcolo', 'MODULE_SHIPPING_ZONES_METHOD', 'Weight', 'Calcolare i costi in base al Peso, al Prezzo o all\'Articolo?', '6', '0', 'zen_cfg_select_option(array(\'Weight\', \'Price\', \'Item\'), ', now())");
      $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) values ('Classe IVA', 'MODULE_SHIPPING_ZONES_TAX_CLASS', '0', 'Applica la seguente aliquota IVA ai costi di spedizione.', '6', '0', 'zen_get_tax_class_title', 'zen_cfg_pull_down_tax_classes(', now())");
      $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Base di Tassa', 'MODULE_SHIPPING_ZONES_TAX_BASIS', 'Shipping', 'Su quali basi vengono calcolate le Tasse sulle Spese di Spedizione.  Le opzioni sono:<br />Shipping - Basata sull\'indirizzo di Spedizione del Cliente<br />Billing - Basata sull\'indirizzo di Fatturazione del Cliente<br />Store - Basata sull\'indirizzo del Negozio se la Zona di Fatturazione/Spedizione &egrave; uguale alla Zona del Negozio', '6', '0', 'zen_cfg_select_option(array(\'Shipping\', \'Billing\', \'Store\'), ', now())");
      $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Ordine di Visualizzazione', 'MODULE_SHIPPING_ZONES_SORT_ORDER', '0', 'Ordine di Visualizzazione.', '6', '0', now())");
      $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Tralasciate i Paesi; usate una virgola per separare la lista dei due caratteri dei codici ISO delle Nazioni', 'MODULE_SHIPPING_ZONES_SKIPPED', '', 'Disabilita per i seguenti Paesi:', '6', '0', 'zen_cfg_textarea(', now())");
      ...
      for ($i = 1; $i <= $this->num_zones; $i++) {
        ...
        $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Zona " . $i ." Paesi', 'MODULE_SHIPPING_ZONES_COUNTRIES_" . $i ."', '" . $default_countries . "', 'La virgola separa la lista dei due caratteri dei codici ISO dei Paesi che fanno parte di una Zona " . $i . ".<br />Impostate 00 per indicare tutti i due caratteri dei codici ISO dei Paesi che non sono definiti in modo specifico.', '6', '0', 'zen_cfg_textarea(', now())");
        $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Zona " . $i ." Tabella di Spedizione', 'MODULE_SHIPPING_ZONES_COST_" . $i ."', '3:8.50,7:10.50,99:20.00', 'Le Aliquote di Spedizione per le destinazioni della Zona " . $i . " in base ad un gruppo di pesi/prezzi massimi di un ordine. Esempio: 3:8.50,7:10.50,...Peso/Prezzo minore o uquale a 3 costerebbe 8.50 per le destinazioni della Zona " . $i . ".<br />Si possono anche usare delle percentuali, come ad esempio 25:8.50,35:5%,40:9.50,10000:7%, per addebitare come costo un valore percentuale calcolato sul Totale Ordine.', '6', '0', 'zen_cfg_textarea(', now())");
