...
<?php require(DIR_WS_MODULES . 'header_languages.php'); require(DIR_WS_MODULES . 'header_currencies.php'); ?>
</div>
	<?php require(DIR_WS_MODULES . 'sideboxes/search_header.php'); ?></div>
<br class="clearBoth" />
</div>
<!--eof-navigation display--><!--bof-branding display-->
<div id="logoWrapper">
<div id="logo">
...
<!--eof-branding display header logo and navigation display-->
