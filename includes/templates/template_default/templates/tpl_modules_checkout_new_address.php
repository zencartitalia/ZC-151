 ...
 * @version $Id: tpl_modules_checkout_new_address.php 4683 2012-01-21 11:58:57 Spike00 aka Paolo De Dionigi $
 */
?>
...
<?php echo zen_draw_input_field('vat', '', zen_set_field_length(TABLE_ADDRESS_BOOK, 'entry_vat', '40') . ' id="vat"') . (zen_not_null(ENTRY_VAT_TEXT) ? '<span class="alert">' . ENTRY_VAT_TEXT . '</span>': ''); ?>
<br class="clearBoth" />
<?php
  }
  if (ACCOUNT_CF == 'true') {?>
<label class="inputLabel" for="fiscalcode"><?php echo ENTRY_CF; ?></label>
<?php echo zen_draw_input_field('fiscalcode', '', zen_set_field_length(TABLE_ADDRESS_BOOK, 'entry_cf', '40') . ' id="fiscalcode"') . (zen_not_null(ENTRY_CF_TEXT) ? '<span class="alert">' . ENTRY_CF_TEXT . '</span>': ''); ?>
<br class="clearBoth" />
<?php
  }
  // P.IVA + CF - end
