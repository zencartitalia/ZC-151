 ...
 */
  ...
  if (!isset($_POST['store_country'])) $_POST['store_country'] = '105';
  if (!isset($_POST['store_zone'])) $_POST['store_zone'] = '';
  if (!isset($_POST['store_address'])) $_POST['store_address'] = STORE_ADDRESS_DEFAULT_VALUE;
  if (!isset($_POST['store_default_language'])) $_POST['store_default_language'] = 'it';
  ...
  setRadioChecked($_POST['demo_install'], 'DEMO_INSTALL', 'true');
