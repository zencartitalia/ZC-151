...
define('ERROR_PASSWORD_RULES', 'Le password devono contenere sia lettere che numeri, devono avere almeno %s caratteri, e devono essere diverse dalle ultime 4 password usate. Le password scadono ogni 90 giorni dopo i quali sar&agrave; richiesto di inserirne una nuova.');
...
define('ERROR_ADMIN_SECURITY_WARNING', 'Attenzione: il tuo account di Admin non &egrave; sicuro... potresti avere ancora i dati di default: admin admin oppure non hai modificato: demo demoonly<br />Per la sicurezza del tuo negozio, i dati di account citati dovrebbero essere modificati al pi&ugrave; presto.');
...
define('BOX_HEADING_PRODUCT_TYPES', 'Tipo Prodotto');
