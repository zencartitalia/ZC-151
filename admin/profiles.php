...
<?php foreach($pagesByMenu as $menuKey => $pageList) { ?>
    <dl>
      <dt>
        ...
        <input class="checkButton" type="button" value="Seleziona Tutti" onclick="checkAll(this.form,'<?php echo $menuKey ?>',true);">
        <input class="checkButton" type="button" value="Deseleziona Tutti" onclick="checkAll(this.form,'<?php echo $menuKey ?>',false);">
      </dt>
