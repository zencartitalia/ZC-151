...
update address_book ab set ab.entry_zone_id = (select zc.id_nuovo from zones_confronto zc where ab.entry_zone_id = zc.id_vecchio and ab.customers_id <=  ID_ULTIMO_CLIENTE_SITO_VECCHIO and ab.entry_zone_id != 0 and ab.entry_country_id = 105);